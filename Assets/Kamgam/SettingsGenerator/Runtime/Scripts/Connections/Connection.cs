...
namespace Kamgam.SettingsGenerator
{
    ...
    public abstract class Connection<TValue> : IConnection<TValue>
    {
        ...
        protected List<IConnection<TValue>.OnChangedDelegate> _onChangedListeners;
        ...
        public void AddChangeListener(IConnection<TValue>.OnChangedDelegate listener)
        {
            if (_onChangedListeners == null)
            {
                _onChangedListeners = new List<IConnection<TValue>.OnChangedDelegate>();
            }
        ...
        public void RemoveChangeListener(IConnection<TValue>.OnChangedDelegate listener)
        {
            if (_onChangedListeners == null)
                return;
