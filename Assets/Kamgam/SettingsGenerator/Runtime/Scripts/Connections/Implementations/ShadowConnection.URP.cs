...
namespace Kamgam.SettingsGenerator
{
    ...
    public partial class ShadowConnection
    {
        ...
        protected void remember()
        {
            ...
            // Add
            if (!previousValue.ContainsKey(GraphicsSettings.renderPipelineAsset))
            {
                previousValue.Add(GraphicsSettings.renderPipelineAsset, rpAsset.shadowDistance);
            }
            else
            {
                ...
                {
                    previousValue[GraphicsSettings.renderPipelineAsset] = rpAsset.shadowDistance;
                }
            }
        }
